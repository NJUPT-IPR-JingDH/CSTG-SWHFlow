    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            if current_step<2:
                ...
                mean, nll, l1, vgg = model.optimize_parameters(current_step)
            ...
            if current_step % opt['logger']['print_freq'] == 0 \
                ...
                message = '<epoch:{:3d}, iter:{:8,d}, lr:{:.3e}, eta:{:.4f}, mean:{:.4f},nll:{:.4f}, l1:{:.4f},vgg:{:.4f}> '.format(
            ...
            if current_step % opt['train']['val_freq'] == 0 and rank <= 0 and current_step>0:
                ...
                for val_data in val_loader:
                    ...
                    util.mkdir(img_dir)
                    # s = val_data['LQ']
                    # val_data['LQ'], m = expand2square(val_data['LQ'], 128)
                    ...
                    # radio=mean_gray_gt / mean_gray_out

                    # mean_gray_out = normal_img.mean()
                    # mean_gray_gt = gt_img.mean()
                    # radio = round(mean_gray_gt / mean_gray_out,8)
                    # cropped_sr_img_adjust = np.clip(cropped_sr_img * radio, 0, 1)
